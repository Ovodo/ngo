...
const Footer = () => {
  return (
    <div className='h-[500px] sm:h-[30vh] lg:h-[544px] justify-between flex-col sm:flex-row py-[60px] lg:py-[159px] px-[20px] lg:px-[125px] text-white w-full bg-docBlue flex'>
      ...
      <div className='flex-col hidden sm:flex font-light  h-full justify-start sm:justify-between'>
        ...
        <Link href={"/about"}>Free Consultation</Link>
      </div>
