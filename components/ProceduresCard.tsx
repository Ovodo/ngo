...
const donors = [
  { name: "Helen Okeke", procedure: "Myomectomy", date: "01/27" },
  { name: "Adewale Abbey", procedure: "Dialysis", date: "01/27" },
  { name: "Funke Ogundele", procedure: "Appendectomy", date: "01/27" },
];

const ProceduresCard = ({ width }: { width: string }) => {
  return (
    <div
      className={`rounded-[20px] h-[459px] relative mx-auto  py-10 bg-white px-5 max-w-[95%] ${width}  shadow-[0px_4.07px_24.45px_-1.02px_#0000001c] backdrop-blur-[40.75px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(40.75px)_brightness(100%)]`}
    >
      ...
      <div className='grid rounded-full text-docAsh text-sm mt-[30px] font-medium py- px-4 grid-cols-[1.5fr,1fr,1fr,1fr]'>
        ...
        <p className='w-full text-center'>Procedure</p>
      ...
      {donors.map((item, index) => {
        return (
          ...
          >
            ...
            <p className='w-full text-center'>{item.procedure}</p>
